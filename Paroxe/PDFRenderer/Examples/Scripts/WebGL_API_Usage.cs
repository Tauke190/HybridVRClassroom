...
namespace Paroxe.PdfRenderer.Examples
{
    public class WebGL_API_Usage : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            PDFJS_Promise<PDFDocument> documentPromise = PDFDocument.LoadDocumentFromUrlAsync("https://drive.google.com/uc?export=download&id=1D1DlUZ8wgiFVFTRf_Rp3zw70HTJq4frM");
