...
namespace Byn.Unity.Examples
{
    ...
    public class ConferenceApp : MonoBehaviour
    {
        ...
        protected virtual void OnCallFactoryReady()
        {
            ...
            MediaConfig.Video = PlayerPrefs.GetInt("Video") == 1;
            ...
            uRoomName.text = Application.productName + "_con";
        ...
        {
            Setup(true, PlayerPrefs.GetInt("Video") == 1);

            EnsureLength();
            //mCall.Listen(uRoomName.text);

            mCall.Listen(Application.productName + PlayerPrefs.GetString("RoomName"));
        }

        public void JoinConferenceCall(bool audio,bool video,string ID)
        {
            Setup(audio,video);
            mCall.Listen(ID);
        }
